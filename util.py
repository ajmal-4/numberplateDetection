...
def get_outputs(net):
    ...
    # Get all the layer names of the network
    layer_names = net.getLayerNames()
    #print(layer_names)

    # Get the layer names of the output layers for forward pass
    output_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers()]
    #print(output_layers)

    # forwrad pass to get the output from output layers
    outs = net.forward(output_layers)

    # Filters out the outs if the confidence is below 0.1
